...
#ifndef __FooBoth_FWD_DEFINED__
#define __FooBoth_FWD_DEFINED__

#ifdef __cplusplus
typedef class FooBoth FooBoth;
#else
typedef struct FooBoth FooBoth;
#endif /* __cplusplus */
...
EXTERN_C const CLSID CLSID_FooBoth;
